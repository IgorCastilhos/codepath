    ...
    chapters: [
      {
        ...
        description:
          'Clientes e servidores, DNS, endereçamento IP, HTTP/HTTPS, portas, ciclo request/response, cookies, sessões e conceitos de performance.',
        longDescription:
        ...
        resources: [
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Rastreie uma Requisição HTTP com DevTools do Navegador',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Construa e Publique um Site Estático HTML/CSS',
        ...
        resources: [
          {
            id: 'ch12-r-os-basics',
            type: 'reading',
            title: 'Kernel, Processos e Gerenciamento de Memória',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Curso Intensivo de Sistemas Operacionais: Do Boot ao Processo',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Domine o Terminal: Navegação de Arquivos e Permissões',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Inspecione Processos em Execução com ps, top e htop',
        ...
        resources: [
          {
            id: 'ch13-r-tcp-ip',
            type: 'reading',
            title: 'O Modelo TCP/IP e Como os Dados Trafegam',
          ...
          },
          {
            id: 'ch13-v-protocols',
            type: 'video',
            title: 'TCP vs UDP e Protocolos de Rede Visualizados',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Construa um Chat TCP Simples com Sockets',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Inspecione Certificados TLS com OpenSSL',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Git por Dentro: Commits, Branches e o DAG',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Fluxo Feature Branch e Pull Requests',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Pratique Branching, Merging e Resolução de Conflitos',
          ...
          },
          {
            id: 'ch14-e-pr-review',
            type: 'exercise',
            title: 'Abra um Pull Request e Conduza um Code Review',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'As Sete Fases do Ciclo de Desenvolvimento de Software',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Ágil, Scrum e Kanban na Prática',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva Histórias de Usuário e Crie um Sprint Backlog',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Configure um Quadro Kanban e Simule uma Sprint',
        ...
        resources: [
          {
            id: 'ch16-r-thinking',
            type: 'reading',
            title: 'Os Quatro Pilares do Pensamento Computacional',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Como Decompor Qualquer Problema de Programação',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Traduza Cenários Reais em Pseudocódigo',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Decomponha uma Funcionalidade Complexa em Sub-Problemas',
  ...
  // ─── Phase 02 — Programming Foundations & DSA ───
  {
    ...
    chapters: [
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Variáveis, Tipos e Fluxo de Controle Explicados',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Condicionais, Loops e Funções em Ação',
          ...
          },
          {
            id: 'ch21-e-fizzbuzz',
            type: 'exercise',
            title: 'Resolva Problemas Clássicos de Lógica: FizzBuzz e Além',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Implemente Fatorial e Fibonacci com Recursão',
      ...
      },
      {
        ...
        description:
          'Classes, objetos, encapsulamento, herança, polimorfismo, composição vs herança, interfaces, classes abstratas e visão geral do SOLID.',
        longDescription:
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Os Quatro Pilares da POO e Quando Usá-los',
          ...
          },
          {
            ...
            type: 'video',
            title: 'POO na Prática: Classes, Herança e Polimorfismo',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Projete uma Hierarquia de Classes para um Sistema de Biblioteca',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Refatore Herança para Composição',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Arrays, Listas, Pilhas, Filas e Mapas Comparados',
          ...
          },
          {
            id: 'ch23-v-big-o',
            type: 'video',
            title: 'Notação Big-O e Performance de Estruturas de Dados',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Implemente uma Pilha e uma Fila do Zero',
          ...
          },
          {
            id: 'ch23-e-hashmap',
            type: 'exercise',
            title: 'Construa um HashMap Simples com Tratamento de Colisão',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Algoritmos de Busca e Ordenação Explicados',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Visualizando Merge Sort, Quick Sort e Busca Binária',
          ...
          },
          {
            id: 'ch24-e-sorting',
            type: 'exercise',
            title: 'Implemente Merge Sort e Quick Sort do Zero',
          ...
          },
          {
            id: 'ch24-e-dp-intro',
            type: 'exercise',
            title: 'Resolva Seus Primeiros Problemas de Programação Dinâmica',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Princípios de Clean Code: Nomes, Funções e DRY',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Refatorando Código Bagunçado em Módulos Limpos',
          ...
          },
          {
            id: 'ch25-e-naming',
            type: 'exercise',
            title: 'Refatore um Código: Melhore Nomes e Reduza Funções',
          ...
          },
          {
            id: 'ch25-e-debugging',
            type: 'exercise',
            title: 'Encontre e Corrija Bugs Usando Breakpoints e Logging',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Testes Unitários, Integração e E2E Explicados',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva Seus Primeiros Testes Unitários com Jest ou JUnit',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Construa uma Calculadora de Strings Usando TDD',
  ...
  // ─── Phase 03 — Backend Beginner ───
  {
    ...
    chapters: [
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Configurando JDK 17+, Maven e Gradle',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Crie um Projeto Maven e Adicione Dependências',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Construa um Endpoint REST Hello World com Spring Boot',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Node.js, npm, nvm e Inicialização de Projeto',
          ...
          },
          {
            id: 'ch32-v-express',
            type: 'video',
            title: 'Construindo APIs REST com Express.js',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Crie uma API CRUD com Express.js e Middlewares',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Organize um Projeto Node.js em Camadas',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Princípios REST, Métodos HTTP e Códigos de Status',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Projetando APIs RESTful que Desenvolvedores Adoram',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Projete e Teste Endpoints RESTful com Postman',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Trate Erros de Forma Elegante com Códigos de Status',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Tabelas, Chaves, Normalização e Design Relacional',
          ...
          },
          {
            ...
            type: 'video',
            title: 'SQL Essencial: SELECT, JOIN e Agregações',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Projete um Esquema Normalizado para um Domínio de E-Commerce',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva Queries SQL Complexas com JOINs e Agregações',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Conceitos de ORM: JDBC, JPA, Prisma e TypeORM',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Conectando Spring Boot e Express ao PostgreSQL',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Crie Migrações e Seeds para um App de Tarefas',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Implemente Transações para uma Funcionalidade de Transferência',
      ...
      },
      {
        ...
        phaseId: 'phase-03',
        order: 18,
        title: 'Autenticação, Autorização & Segurança Web',
        description:
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Autenticação vs Autorização: JWT, Sessões, OAuth2',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Segurança Web: XSS, CSRF, SQL Injection e Defesas',
          ...
          },
          {
            id: 'ch36-e-jwt-auth',
            type: 'exercise',
            title: 'Implemente Autenticação JWT com Refresh Tokens',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Audite e Corrija Vulnerabilidades de Segurança em uma API',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Nomenclatura RESTful, Versionamento e Breaking Changes',
          ...
          },
          {
            id: 'ch37-v-openapi',
            type: 'video',
            title: 'Documentando APIs com OpenAPI e Swagger UI',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva uma Spec OpenAPI e Gere Docs Swagger',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Adicione Versionamento de API e Depreciação ao Seu Servidor',
      ...
      },
      {
        ...
        phaseId: 'phase-03',
        order: 20,
        title: 'Projeto de Backend Iniciante',
        description:
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Planejando um Projeto de API Full-Stack: Escopo e Arquitetura',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Construindo e Fazendo Deploy de uma API REST Completa',
          ...
          },
          {
            id: 'ch38-e-build-api',
            type: 'exercise',
            title: 'Construa uma API de Gerenciador de Tarefas com Auth e PostgreSQL',
          ...
          },
          {
            id: 'ch38-e-deploy',
            type: 'exercise',
            title: 'Faça Deploy da Sua API no Railway ou Render',
  ...
  // ─── Phase 04 — Backend Advanced & Software Engineering ───
  {
    ...
    chapters: [
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'A Pirâmide de Testes, Mocks, Stubs e Fakes',
          ...
          },
          {
            ...
            type: 'video',
            title: 'TDD Avançado: Testes de Contrato e Testes de Carga',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Refatore Testes para Usar Mocks, Stubs e Fakes',
          ...
          },
          {
            id: 'ch41-e-load-test',
            type: 'exercise',
            title: 'Escreva Testes de Carga com k6 ou Artillery',
      ...
      },
      {
        ...
        phaseId: 'phase-04',
        order: 22,
        title: 'Clean Code & SOLID Avançado',
        description:
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Princípios SOLID em Profundidade com Exemplos Reais',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Refatorando para SOLID: Antes e Depois',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Identifique e Corrija Violações SOLID em um Código',
          ...
          },
          {
            id: 'ch42-e-coupling',
            type: 'exercise',
            title: 'Reduza Acoplamento e Aumente Coesão com DI',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Clean Architecture: Camadas, Boundaries e Adapters',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Implementando Clean Architecture em Java e Node.js',
          ...
          },
          {
            id: 'ch43-e-layers',
            type: 'exercise',
            title: 'Reestruture uma App Monolítica em Camadas de Clean Architecture',
          ...
          },
          {
            id: 'ch43-e-adapters',
            type: 'exercise',
            title: 'Troque Banco e Framework Usando Adapters',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Blocos do DDD: Entidades, Value Objects, Agregados',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Domain-Driven Design na Prática com Bounded Contexts',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Modele um Domínio de E-Commerce com Padrões DDD',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Desenhe um Mapa de Contextos e Defina Bounded Contexts',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Índices, Planos de Execução e Otimização no PostgreSQL',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Transações, Níveis de Isolamento e Prevenção de Deadlocks',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Otimize Queries Lentas com EXPLAIN ANALYZE e Índices',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Armazene e Consulte Dados no MongoDB e Redis',
        ...
        resources: [
          {
            id: 'ch46-r-caching',
            type: 'reading',
            title: 'Estratégias de Cache: TTL, Write-Through e Cache-Aside',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Escalabilidade Horizontal, Load Balancers e Rate Limiting',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Adicione Cache Redis a uma API Existente',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Implemente Rate Limiting e Load Balancing com Nginx',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Conceitos Docker: Imagens, Containers e Camadas',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Containerizando Apps com Docker e docker-compose',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Containerize uma App Java ou Node.js com PostgreSQL',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Otimize Tamanho de Imagem com Multi-Stage Builds',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Cloud Computing: IaaS, PaaS, FaaS Comparados',
          ...
          },
          {
            id: 'ch48-v-cicd',
            type: 'video',
            title: 'Construindo Pipelines CI/CD com GitHub Actions',
          ...
          },
          {
            id: 'ch48-e-pipeline',
            type: 'exercise',
            title: 'Crie um Pipeline CI/CD que Builda, Testa e Faz Deploy',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Adicione Health Checks e Logging Estruturado à Sua API',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Secure Coding, LGPD/GDPR e Práticas de Criptografia',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Conduzindo uma Revisão de Segurança de Endpoints',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Crie um Modelo de Ameaças e Checklist de Segurança',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Implemente Gestão de Segredos com Variáveis de Ambiente',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Monolitos, Microsserviços, Filas e Design Event-Driven',
          ...
          },
          {
            ...
            type: 'video',
            title: 'Projetando para Escala: Alta Disponibilidade e Tolerância a Falhas',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Projete um Sistema Escalável de Encurtador de URLs',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Desenhe Diagramas C4 para uma Arquitetura Existente',
        ...
        resources: [
          {
            ...
            type: 'reading',
            title: 'Construindo um Portfólio de Desenvolvedor: README, ADRs e Estudos de Caso',
          ...
          },
          {
            id: 'ch411-v-career',
            type: 'video',
            title: 'Habilidades de Carreira: Comunicação, Feedback e Trabalho em Equipe',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva um README e ADR Profissional para Seu Projeto',
          ...
          },
          {
            ...
            type: 'exercise',
            title: 'Escreva um Estudo de Caso e Post-Mortem para um Projeto',
